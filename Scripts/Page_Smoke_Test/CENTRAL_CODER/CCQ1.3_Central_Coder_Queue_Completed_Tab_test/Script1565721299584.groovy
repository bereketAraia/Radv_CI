...
'RM-464.2\r\n'
WebUI.verifyElementText(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/Hero/hero_a_Completed ()'), 
    'Completed (0)')
...
'RM-464.8'
WebUI.verifyElementNotClickable(findTestObject('CENTRAL_CODER/INTAKE_NEW_P1_Central_Coder_Queue_Page/td_1_coversheet_a_CY 2015 Contract-Level RADV-'))
