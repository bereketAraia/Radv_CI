...
'RM 30.3 check upload Date is ordered DESC'
WebUI.verifyElementText(findTestObject('PLAN_PORTAL/LIBRARY_Plan_Team_Library_Page/button_Upload Date'), 'UPLOAD DATE DESCENDING')

WebUI.delay(3)

'RM-30'
WebUI.click(findTestObject('PLAN_PORTAL/LIBRARY_Plan_Team_Library_Page/table_row1_td1'))
