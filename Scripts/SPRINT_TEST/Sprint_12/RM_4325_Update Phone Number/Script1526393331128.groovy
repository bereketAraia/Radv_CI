...
WebUI.verifyElementPresent(findTestObject('USER_Management/MyAccount/label_Contact Phone Number'), 0)

WebUI.verifyElementPresent(findTestObject('USER_Management/MyAccount/label_Contact Phone Extension'), 0)

WebUI.click(findTestObject('USER_Management/MyAccount/button_Edit_contact'))

WebUI.delay(2)

WebUI.setText(findTestObject('USER_Management/MyAccount/input_phonePrimaryInput'), '2025529888')
