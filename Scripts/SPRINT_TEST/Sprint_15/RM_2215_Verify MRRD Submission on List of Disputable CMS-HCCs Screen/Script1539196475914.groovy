...
WebUI.verifyElementPresent(findTestObject('MRRD_MANAGEMENT/List_Of_Disputable/Content/Row1_C1_span_Not Started'), 2)

WebUI.verifyElementPresent(findTestObject('MRRD_MANAGEMENT/List_Of_Disputable/Content/Row1_C2_span_Cxxxxxxxxxxxxx'), 2)
