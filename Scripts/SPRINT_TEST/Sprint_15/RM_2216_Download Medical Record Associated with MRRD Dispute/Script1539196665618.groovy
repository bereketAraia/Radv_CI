...
WebUI.click(findTestObject('MRRD_MANAGEMENT/List_Of_Disputable/Content/Row1_C2_span_Cxxxxxxxxxxxxx'))

WebUI.delay(2)

WebUI.click(findTestObject('MRRD_MANAGEMENT/Page_Medical Record Review Determination/Content/button_Download Medical Record'))
