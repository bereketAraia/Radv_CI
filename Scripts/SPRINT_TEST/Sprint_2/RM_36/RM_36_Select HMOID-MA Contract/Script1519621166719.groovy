...
'36.2'
WebUI.verifyElementPresent(findTestObject('PLAN_PORTAL/PORTAL_NEW_P2_Plan_Portal_Page/Thead_button_Progress'), 0)

WebUI.verifyElementPresent(findTestObject('PLAN_PORTAL/PORTAL_NEW_P2_Plan_Portal_Page/Thead_button_Contract Name'), 0)

WebUI.verifyElementPresent(findTestObject('PLAN_PORTAL/PORTAL_NEW_P2_Plan_Portal_Page/Thead_Enrollee List'), 0)

WebUI.verifyElementPresent(findTestObject('PLAN_PORTAL/PORTAL_NEW_P2_Plan_Portal_Page/Thead_More'), 0)
...
'36.5'
WebUI.verifyElementClickable(findTestObject('PLAN_PORTAL/PORTAL_NEW_P2_Plan_Portal_Page/FirstContract_td_more_tr1'))
