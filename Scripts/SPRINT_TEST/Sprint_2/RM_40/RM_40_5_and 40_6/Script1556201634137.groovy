...
WebUI.setText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P3_List_Enrollees_Page/Search_input_keyword'), '')
...
WebUI.verifyElementText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P3_List_Enrollees_Page/search_error_msg'), 'Please enter search criteria.')

WebUI.delay(3)

WebUI.setText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P3_List_Enrollees_Page/Search_input_keyword'), 'xxxxxx')
...
WebUI.verifyElementText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P3_List_Enrollees_Page/p_No results found.'), 'No results found.')
