...
WebUI.click(findTestObject('RECON_CENTRAL_CODER/MAIN/sample dropDown menu'))

WebUI.click(findTestObject('PLAN_PORTAL/PORTAL_NEW_P1_Accept_Page/button_CY 2015 Reconsideration'))

WebUI.delay(5, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P3_List_Enrollees_Page/Search_input_keyword'), '621')
...
WebUI.verifyElementText(findTestObject('RECON_CENTRAL_CODER/MAIN/td_MRRC Senior Coder - Returned from Technical Writer'), 
    'MRRC Senior Coder - Returned from Technical Writer')
