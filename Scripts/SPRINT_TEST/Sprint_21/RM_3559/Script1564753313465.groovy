...
//WebUI.verifyElementText(findTestObject('CMS_USER/MRRD_Management/main_Content/Search by Dispute ID or Coversheet ID_keyword - text'), 
//'Search by Dispute ID or Coversheet ID')
disputeID = WebUI.getText(findTestObject('CMS_USER/MRRD_Management/main_Content/td_1_Disputed ID'))

WebUI.delay(3)

WebUI.setText(findTestObject('CMS_USER/MRRD_Management/main_Content/input_Search by Dispute ID or Coversheet ID_keyword'), 
    disputeID)
