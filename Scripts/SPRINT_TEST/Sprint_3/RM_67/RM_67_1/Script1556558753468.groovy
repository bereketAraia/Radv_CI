...
WebUI.verifyElementText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P6_Review_Coversheet_Page/Text_h4_Your upload has passed all crieteria_message'), 
    'Your upload is still being evaluated')
