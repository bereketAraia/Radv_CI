...
WebUI.verifyElementText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P4_Enrollee_Sub_Mang_Page/Modal_removeCoversheet/a_Proceed with remove'), 
    'PROCEED WITH REMOVE')

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P4_Enrollee_Sub_Mang_Page/Modal_removeCoversheet/button_Keep Coversheet'), 
    'KEEP COVERSHEET')
