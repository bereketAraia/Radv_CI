...
WebUI.click(findTestObject('PLAN_PORTAL/PORTAL_NEW_P3_List_Enrollees_Page/button_Not Started'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementNotClickable(findTestObject('PLAN_PORTAL/PORTAL_NEW_P4_Enrollee_Sub_Mang_Page/bottom_a_Change Rank'), 
