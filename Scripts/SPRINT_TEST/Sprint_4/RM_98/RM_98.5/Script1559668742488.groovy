...
WebUI.verifyElementText(findTestObject('PLAN_PORTAL/PORTAL_NEW_P4.3_Coversheet_Summary_Page/hero_button_Back To  Enrollee Submission'), 
    'Back To Enrollee Submission Management')

WebUI.delay(2)

WebUI.click(findTestObject('PLAN_PORTAL/PORTAL_NEW_P4.3_Coversheet_Summary_Page/hero_button_Back To  Enrollee Submission'))
