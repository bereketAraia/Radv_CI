...
Runtime.getRuntime().exec(GlobalVariable.autoIT_chrome_100MB)
...
'progress bas is visible\r\n'
WebUI.verifyElementVisible(findTestObject('PLAN_PORTAL/PORTAL_NEW_P5_Medical_Record_coversheet_Page/button_Progress_bar'))
