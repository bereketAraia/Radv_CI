...
WebUI.click(findTestObject('Old_Objects/INTAKE_P1_Central_Coder_Queue_Page/a_In Escalation (0)'))

WebUI.delay(4)

WebUI.click(findTestObject('Old_Objects/INTAKE_P1_Central_Coder_Queue_Page/button_Complete'))
