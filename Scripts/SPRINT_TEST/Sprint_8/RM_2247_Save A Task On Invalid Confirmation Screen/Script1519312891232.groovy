...
WebUI.verifyElementPresent(findTestObject('Old_Objects/INTAKE_P4_Ivalid_Confirmation_Page/Section_3/label_Attestation altered'), 0)

WebUI.verifyElementPresent(findTestObject('Old_Objects/INTAKE_P4_Ivalid_Confirmation_Page/Section_3/label_Attestation incomplete'), 2)

WebUI.verifyElementPresent(findTestObject('Old_Objects/INTAKE_P4_Ivalid_Confirmation_Page/Section_3/label_Date of service mismatch'), 0)

WebUI.verifyElementPresent(findTestObject('Old_Objects/INTAKE_P4_Ivalid_Confirmation_Page/Section_3/label_Incorrect enrollee'), 0)

WebUI.verifyElementPresent(findTestObject('Old_Objects/INTAKE_P4_Ivalid_Confirmation_Page/Section_3/label_Inpatient record'), 0)

WebUI.verifyElementPresent(findTestObject('Old_Objects/INTAKE_P4_Ivalid_Confirmation_Page/Section_3/label_Other'), 5)

WebUI.click(findTestObject('Old_Objects/INTAKE_P4_Ivalid_Confirmation_Page/Detail_page/button_Saving_Save'))

WebUI.delay(3)

WebUI.click(findTestObject('Old_Objects/INTAKE_P4_Ivalid_Confirmation_Page/Detail_page/button_Details'))
