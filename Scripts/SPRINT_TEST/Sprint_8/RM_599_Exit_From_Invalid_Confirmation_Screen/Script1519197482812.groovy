...
WebUI.click(findTestObject('INTAKE_Invalid_Confirmation_Page_RADV/Page_RADV CDAT (1)/div_Check all that exists with'))
...
WebUI.click(findTestObject('INTAKE_Invalid_Confirmation_Page_RADV/button_Exit'))

WebUI.verifyElementVisible(findTestObject('INTAKE_Invalid_Confirmation_Page_RADV/button_Continue Working_EXIT'))

WebUI.verifyElementVisible(findTestObject('INTAKE_Invalid_Confirmation_Page_RADV/button_Dont Save_EXIT'))

WebUI.verifyElementVisible(findTestObject('INTAKE_Invalid_Confirmation_Page_RADV/button_Save_EXIT'))

WebUI.click(findTestObject('INTAKE_Invalid_Confirmation_Page_RADV/button_Dont Save_EXIT'))
