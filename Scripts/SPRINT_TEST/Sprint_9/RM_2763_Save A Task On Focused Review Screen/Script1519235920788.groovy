...
WebUI.verifyElementNotClickable(findTestObject('Old_Objects/INTAKE_P5_Focused_Review_Page/Focused_codeMR/button_Saving_Save'))

WebUI.click(findTestObject('Old_Objects/INTAKE_P5_Focused_Review_Page/Focused_details_Tab/Button_a_View Submission'))

'2763.1'
WebUI.click(findTestObject('Old_Objects/INTAKE_P5_Focused_Review_Page/Focused_codeMR/button_Saving_Save'))

WebUI.delay(3)

WebUI.click(findTestObject('Old_Objects/INTAKE_P5_Focused_Review_Page/Focused_details_Tab/button_Details'))
