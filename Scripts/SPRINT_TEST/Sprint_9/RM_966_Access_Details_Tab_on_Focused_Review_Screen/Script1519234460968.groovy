...
WebUI.verifyElementClickable(findTestObject('Old_Objects/INTAKE_P5_Focused_Review_Page/Focused_details_Tab/button_Code MR'))
...
WebUI.verifyElementPresent(findTestObject('Old_Objects/INTAKE_P5_Focused_Review_Page/Focused_details_Tab/Text_h1_Focused Review'), 0)
